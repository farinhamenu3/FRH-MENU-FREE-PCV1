# FRH-MENU-FREE-PCV1-- =============================================================================
-- PAINEL FRH MENU - VERSÃO COMPLETA FUNCIONAL
-- =============================================================================
...
local function createTab(name, isDefault)
	...
	TabBtn.MouseButton1Click:Connect(function()
		...
		for _, btn in pairs(tabButtons) do 
			...
			if stroke then stroke.Color = Color3.fromRGB(60, 50, 70) end
		end
		Page.Visible = true
...
createToggle(AimbotPage, "Team Check (Ignorar Aliados)", true, function(state) 
	CheatSettings.TeamCheck = state 
end)

createToggle(AimbotPage, "Wall Check", false, function(state) 
	CheatSettings.WallCheck = state 
end)

createSlider(AimbotPage, "Raio do FOV", 30, 300, 150, function(val) 
	CheatSettings.FovRadius = val 
end)

createSlider(AimbotPage, "Suavidade", 5, 20, 8, function(val) 
...
WhitelistTitle.Text = "Whitelist (Marcar para IGNORAR):"
...
WhitelistScroll.AutomaticCanvasSize = Enum.AutomaticSize.XY
...
Players.PlayerAdded:Connect(function(player)
	task.spawn(function() CreateESPObject(player) end)
end)
...
local function GetClosestEnemy()
	...
	for _, player in pairs(Players:GetPlayers()) do
		...
		if CheatSettings.Whitelist[player.UserId] then continue end
		...
		if CheatSettings.FovEnabled and dist > CheatSettings.FovRadius then
			continue
		end
...
local function DoAimbot()
	...
	local deltaX = (headPos.X - mousePos.X) / CheatSettings.Smoothness
	local deltaY = (headPos.Y - mousePos.Y) / CheatSettings.Smoothness
...
UserInputService.InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton2 then
		isAiming = true
		if CheatSettings.AimbotEnabled then
			DoAimbot()
		end
	end
end)
...
RunService.RenderStepped:Connect(function()
	...
	if CheatSettings.AimbotEnabled and isAiming then
		DoAimbot()
	end
end)
...
FooterText.Text = "FRH MENU | Aimbot: Segure Botão DIREITO | Team Check ATIVADO"
...
print("========================================")
print("🟢 FRH MENU CARREGADO COM SUCESSO!")
print("🎯 Aimbot: Segure o botão DIREITO do mouse")
print("✅ Team Check ATIVADO (só mira em inimigos)")
print("📌 Pressione RIGHT CONTROL para abrir/fechar")
print("========================================")
